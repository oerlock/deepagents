...
## [0.1.0](https://github.com/oerlock/deepagents/compare/deepagents-cli==0.0.28...deepagents-cli==0.1.0) (2026-03-06)
...
* **cli:** add configurable timeout to `ShellMiddleware` ([#961](https://github.com/oerlock/deepagents/issues/961)) ([bc5e417](https://github.com/oerlock/deepagents/commit/bc5e4178a76d795922beab93b87e90ccaf99fba6))
...
* **cli:** add expandable shell command display in HITL approval ([#976](https://github.com/oerlock/deepagents/issues/976)) ([fb8a007](https://github.com/oerlock/deepagents/commit/fb8a007123d18025beb1a011f2050e1085dcf69b))
...
* **cli:** add timeout formatting to enhance `shell` command display ([#987](https://github.com/oerlock/deepagents/issues/987)) ([cbbfd49](https://github.com/oerlock/deepagents/commit/cbbfd49011c9cf93741a024f6efeceeca830820e))
...
* **cli:** display thread ID at splash ([#988](https://github.com/oerlock/deepagents/issues/988)) ([e61b9e8](https://github.com/oerlock/deepagents/commit/e61b9e8e7af417bf5f636180631dbd47a5bb31bb))
...
* **cli:** model identity ([#770](https://github.com/oerlock/deepagents/issues/770)) ([e54a0ee](https://github.com/oerlock/deepagents/commit/e54a0ee43c7dfc7fd14c3f43d37cc0ee5e85c5a8))
...
* **sdk:** sandbox provider interface ([#900](https://github.com/oerlock/deepagents/issues/900)) ([d431cfd](https://github.com/oerlock/deepagents/commit/d431cfd4a56713434e84f4fa1cdf4a160b43db95))
...
* **cli:** improve clipboard copy/paste on macOS ([#960](https://github.com/oerlock/deepagents/issues/960)) ([3e1c604](https://github.com/oerlock/deepagents/commit/3e1c604474bd98ce1e0ac802df6fb049dd049682))
...
* **cli:** make `pyperclip` hard dep ([#985](https://github.com/oerlock/deepagents/issues/985)) ([0f5d4ad](https://github.com/oerlock/deepagents/commit/0f5d4ad9e63d415c9b80cd15fa0f89fc2f91357b)), closes [#960](https://github.com/oerlock/deepagents/issues/960)
...
* **cli:** revert, improve clipboard copy/paste on macOS ([#964](https://github.com/oerlock/deepagents/issues/964)) ([4991992](https://github.com/oerlock/deepagents/commit/4991992a5a60fd9588e2110b46440337affc80da))
...
* **cli:** update timeout message for long-running commands in `ShellMiddleware` ([#986](https://github.com/oerlock/deepagents/issues/986)) ([dcbe128](https://github.com/oerlock/deepagents/commit/dcbe12805a3650e63da89df0774dd7e0181dbaa6))
...
* **infra:** change `release-please` component ([#1002](https://github.com/oerlock/deepagents/issues/1002)) ([cb572b9](https://github.com/oerlock/deepagents/commit/cb572b941f94b910cc5b5a49b93f246cd0eb02fa))
